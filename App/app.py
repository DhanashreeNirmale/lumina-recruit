...
with tab1:
    ...
    with col2:
        ...
        if job_description:
            with st.spinner("Extracting job skills..."):
    ...
    if screenings:
        ...
        for screening in screenings:
            with st.expander(
                ...
                with col2:
                    st.write(f"**Score:** {screening['score']}%")
                    st.write(f"**Matched:** {screening['total_matched']}/{screening['total_required']}")
                
                st.write("**Matched Skills:**")
                if screening['matched_skills']:
                    st.write(", ".join(screening['matched_skills']))
                else:
                    st.write("None")
                
                st.write("**Missing Skills:**")
                if screening['missing_skills']:
                    st.write(", ".join(screening['missing_skills']))
                else:
                    st.write("None")
